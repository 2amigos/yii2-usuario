 ...
 */
return [
    'According to the European General Data Protection Regulation (GDPR) we need your consent to work with your personal data.' => 'De acuerdo a la normativa europea de protección de datos es necesario su consentimiento para el tratamiento de sus datos personales.',
    'Data privacy' => 'Protección de datos',
    'Submit' => 'Enviar',
    'Unfortunately, you can not work with this site without giving us consent to process your data.' => 'Desafortunadamente no podrá utilizar este sitio mientras no nos dé su consentimiento para el tratamiento de sus datos.',
    'Your consent is required to work with this site' => 'Se requiere su consentimiento para poder acceder a este sitio.',
