...
return [
	...
	'I aggree processing of my personal data and the use of cookies to facilitate the operation of this site. For more information read our {privacyPolicy}' => 'Ik ga akkoord met het feit dat mijn persoonlijke data en cookies worden verwerkt voor het gebruik van deze website. Voor meer informatie lees onze {privacyPolicy}',
	'Invalid two-factor code' => 'Ongeldige tweetraps authenticatie code',
	'Last login' => 'Laatste login',
	'Registration ip' => 'Registratie IP',
	'Rule class can not be instantiated' => 'Regel class kan niet worden aangemaakt',
