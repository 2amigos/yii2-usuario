...
return [
    ...
    'An email with instructions to create a new password has been sent to {email} if it is associated with an {appName} account. Your existing password has not been changed.' => 'Una mail con le istruzioni per creare una nuova password è stata inviata all\'indirizzo {email} se associata a un account {appName}. La tua password non è ancora stata cambiata.',
    'Data privacy' => 'Data privacy',
    'Submit' => 'Invia',
    'Unfortunately, you can not work with this site without giving us consent to process your data.' => 'Sfortunatamente non puoi navigare sul sito senza il tuo consenso per l\'utilizzo dei dati personali.',
    'Your consent is required to work with this site' => 'Il tuo consenso è richiesto per navigare sul sito',
