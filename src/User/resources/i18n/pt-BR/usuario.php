...
return [
    ...
    'According to the European General Data Protection Regulation (GDPR) we need your consent to work with your personal data.' => 'De acordo com o Regulamento Geral Europeu sobre a Proteção de Dados (GDPR) nós precisamos do seu consentimento para trabalhar com seus dados pessoais.',
    'An email with instructions to create a new password has been sent to {email} if it is associated with an {appName} account. Your existing password has not been changed.' => 'Um e-mail com as instruções para criar uma nova senha foi enviado para {email}, se ele estiver associado com uma conta {appName}. Sua senha atual não foi alterada.',
    'Data privacy' => 'Privacidade de dados',
    'Rule class name' => 'Nome da classe de regras',
    'Select rule...' => 'Selecione regra...',
    'Submit' => 'Enviar',
    'Two factor authentication protects you in case of stolen credentials' => 'Autenticação de dois fatores protege você contra credenciais roubadas',
    'Unfortunately, you can not work with this site without giving us consent to process your data.' => '',
    'Your consent is required to work with this site' => 'É necessário o seu consentimento para trabalhar neste site',
