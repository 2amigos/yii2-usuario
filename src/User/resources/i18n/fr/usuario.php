...
return [
    '(not set)' => 'non défini',
    'A confirmation message has been sent to your new email address' => 'Un message de confirmation a été envoyé à votre nouvelle addresse email',
    'A message has been sent to your email address. It contains a confirmation link that you must click to complete registration.' => 'Un message a été envoyé à votre addresse email',
    ...
    'Are you sure you want to switch to this user for the rest of this Session?' => 'Êtes-vous sûr de vouloir changer vers cet utilisateur pour le reste de cette Session?',
    'Are you sure you want to unblock this user?' => 'Êtes-vous sûr de vouloir déverouiller cet utilisateur?',
    ...
    'Are you sure you wish to send a password recovery email to this user?' => 'Souhaitez-vous vraiment envoyer un email de récuperation de mot de passe à cet utilisateur?',
    'Are you sure? Deleted user can not be restored' => 'Êtes-vous sûr? Les utilisateurs supprimés ne peuvent pas être restaurés',
    'Are you sure? There is no going back' => 'Êtes-vous sûr? Il n\'y a pas de retour arrière possible',
    'Assignments' => 'Affectations',
    'Assignments have been updated' => 'Les affectations ont été mises à jour',
    'Auth item with such name already exists' => 'Un élément d\'Auth avec le même nom existe déjà',
    ...
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address.' => 'Génial, vous y êtes presque. Vous devez maintenant cliquer sur le lien de confirmation depuis votre nouvelle addresse email',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address.' => 'Génial, vous y êtes presque. Vous devez maintenant cliquer sur le lien de confirmation depuis votre ancienne addresse email',
    'Back to privacy settings' => 'Retour aux réglages de confidentialité',
    'Bio' => 'Biographie',
    'Block' => 'Verouiller',
    'Block status' => 'État du verouillage',
    'Blocked at {0, date, MMMM dd, YYYY HH:mm}' => 'Verouillé depuis le {0, date, dd MMMM YYYY HH:mm}',
    'Cancel' => 'Annuler',
    'Cannot assign role "{0}" as the AuthManager is not configured on your console application.' => 'Impossible d\'assigner le rôle {0} tant que AuthManager n\'est pas configuré depuis la console de l\'application.',
    ...
    'Error sending registration message to "{email}". Please try again later.' => 'Erreur lors de l\'envoi du message d\'inscription à "{email}". Veuillez essayer plus tard.',
    'Error sending welcome message to "{email}". Please try again later.' => 'Erreur lors de l\'envoi du message de bienvenue à "{email}". Veuillez essayer plus tard.',
    ...
    'Impersonate this user' => 'Connecter en tant que cet utilisateur',
    ...
    'Please be certain' => 'Soyez certains',
    ...
    'Recovery link is invalid or expired. Please try requesting a new one.' => 'Le lien de récuperation a expiré ou est invalide. Veuillez tenter à nouveau de faire une demande',
    ...
    'Request new confirmation message' => 'Demander un noouveau message de confirmation',
    ...
    'Role "{0}" not found. Creating it.' => 'Rôle "{0}" introuvable. Creation en cours.',
    'Roles' => 'Rôles',
    'Rule' => 'Règle',
    ...
    'Rules' => 'Règles',
    'Save' => 'Enregistrer',
    'Scan the QrCode with Google Authenticator App, then insert its temporary code on the box and submit.' => 'Scanner le QrCode à l\'aide de l\'application Google Authenticator, ensuite entrez le code temporaire dans l\'emplacement prévu à cet effet puis validez.',
    'Select rule...' => 'Sélectionner une règle...',
    'Send password recovery email' => 'Envoyer un email de récuperation de mot de passe',
    ...
    'The verification code is incorrect.' => 'Le code de vérification est incorrecte',
    ...
    'This will remove your personal data from this site. You will no longer be able to sign in.' => 'Cela va supprimer vos données personnelles de ce site. Vous ne pourrez plus vous connecter.',
    'Time zone' => 'Fuseau horaire',
    'Time zone is not valid' => 'Le fuseau horaire n\'est invalide',
    ...
    'Unable to update block status.' => 'Impossible de mettre à jour le status de verouillage',
    'Unblock' => 'Dévérouillé',
    ...
    'User block status has been updated.' => 'le status de verrouillage a été mis à jour.',
    ...
    'Users' => 'Utilisteurs',
    'VKontakte' => 'VKontakte',
    'Verification failed. Please, enter new code.' => 'La vérification a echoué. Veuillez entrer un nouveau code.',
    ...
    'We have sent confirmation links to both old and new email addresses. You must click both links to complete your request.' => 'Nous avons envoyé des liens de confirmation à vos nouvel et ancienne adresses email.',
    'Website' => 'Site web',
    ...
    'Your account has been blocked' => 'Votre compte a été vérouillé',
    'Your account has been blocked.' => 'Votre compte a été vérouillé.',
    ...
    'Your account has been created and a message with further instructions has been sent to your email' => 'Votre compte a été créé et un message avec les instructions complètes a été envoyé à votre adress email',
