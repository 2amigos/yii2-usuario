...
namespace Da\Usuario\Rbac\Component;

use Da\Usuario\Rbac\Contracts\AuthManagerInterface;
use yii\db\Query;
use yii\rbac\DbManager;

class AuthDbManager extends DbManager implements AuthManagerInterface
{
    /**
     ...
     * @return array
     */
    public function getItems(?int $type, array $excludeItems = []): array
    {
